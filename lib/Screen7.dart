      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 30,right: 30,bottom: 20,top: 56),
              child: Text
            ...
            const Padding(
              ...
              child: Text("enter a new password",textAlign: TextAlign.center,style: TextStyle(
                fontSize: 16,
              ),),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 28,right: 28,top: 40,bottom: 20),
              child: Container(
                  height: 49,
                  width: 320,
                  decoration: BoxDecoration(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30,right: 28,top: 36),
